...
echo "type sudo chmod 666 /var/run/docker.sock to get permission to connect to the Docker daemon socket"
echo "type docker run -it -p 5000:5000 bitgesell-node-monitor to start the container"
echo ""
echo "done."
